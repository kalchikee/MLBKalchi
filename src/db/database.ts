...
// the embed stays compact early in the season. Mirrors the season filter
// used by computeSeasonStats() (graded predictions, no date cutoff) so
// morning + evening agree on which picks are in the population.
